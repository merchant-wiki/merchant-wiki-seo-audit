...
1. Upload the plugin files to the `/wp-content/plugins/merchant-wiki-seo-audit` directory, or install the plugin through the WordPress plugins screen directly.
